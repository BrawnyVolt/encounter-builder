...
//////////////////////////////
        ...
        function gettingTheQuantities(){
                    //same deal, grab the array of inputs, for loop them and confirm
            
            let ListOfQuantities = document.getElementsByTagName('input');
            let index;
            for (index = 0; index < ListOfQuantities.length; ++index) {
            console.log(ListOfQuantities[index].value);
            } }


        //////for the post, for-loop both arrays together, grabbin [index whatever] from both and pushing it into the join table. also need the encounter id. do fetch get monster_encounter.last encounter_id
